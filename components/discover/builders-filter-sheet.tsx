...
} from './builders-filter-rail';

/**
 * Full-screen filter sheet for mobile builders directory. Opened from the toolbar's
 * filter button; fills the viewport, scrolls the rail, and keeps Reset/Done pinned.
 * Triggered only below `lg`, where the inline rail is hidden.
 */
export function BuildersFilterSheet({
  open,
  onOpenChange,
  value,
  onChange,
