// Generated by scripts/generate-icons.mjs from svg/linear/gps.svg. Do not edit.
import type { SVGProps } from 'react';

export function GpsIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width={24}
      height={24}
