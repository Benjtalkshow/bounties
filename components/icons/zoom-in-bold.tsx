// Generated by scripts/generate-icons.mjs from svg/bold/zoom-in.svg. Do not edit.
import type { SVGProps } from 'react';

export function ZoomInBoldIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width={24}
      height={24}
