// Generated by scripts/generate-icons.mjs from svg/bold/upload.svg. Do not edit.
import type { SVGProps } from 'react';

export function UploadBoldIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width={24}
      height={24}
    ...
    >
      <g>
        ...
        />
        <path
          d='M3 17.5H10.063C10.285 18.3626 11.0681 19 12 19C12.9319 19 13.715 18.3626 13.937 17.5H21V19C21 20.6569 19.6569 22 18 22H6C4.34315 22 3 20.6569 3 19V17.5Z'
          fill='currentColor'
        />
      </g>
    </svg>
