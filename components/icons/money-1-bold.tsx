// Generated by scripts/generate-icons.mjs from svg/bold/money-1.svg. Do not edit.
import type { SVGProps } from 'react';

export function Money1BoldIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      width={24}
      height={24}
